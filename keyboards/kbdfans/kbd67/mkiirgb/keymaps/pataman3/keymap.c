...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_65_ansi_blocker(
	    ...
	    KC_BSPC,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,   KC_ENT,  XXXXXXX,  XXXXXXX,\
		  KC_LSFT,  KC_SLSH,  KC_LABK,  KC_LCBR,  KC_LBRC,  KC_LPRN,  KC_RPRN,  KC_RBRC,  KC_RCBR,  KC_RABK,  KC_BSLS,  KC_RSFT,  XXXXXXX,  XXXXXXX,\
  ...
  [3] = LAYOUT_65_ansi_blocker(
	    ...
	    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_LEFT,  KC_DOWN,    KC_UP,  KC_RGHT,  XXXXXXX,  XXXXXXX,  XXXXXXX,\
		  ...
		  XXXXXXX,    TO(0),    TO(1),  XXXXXXX,  XXXXXXX,    TO(3),    TO(4),  XXXXXXX,  XXXXXXX
  ),
  [4] = LAYOUT_65_ansi_blocker(
		  ...
		  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,\
		  XXXXXXX,    TO(0),    TO(1),  RGB_TOG,  RGB_TOG,    TO(3),    TO(4),  XXXXXXX,  XXXXXXX
  ),
};
